...
declare function xf:XQ_SMSPayload_To_CreateCommunicationRequest_Req1($sMSRequestPayload1 as element(ns2:SMSRequestPayload))
        ...
        <ns0:CreateCommunicationVBMRequest>
            <ns0:CommunicationVBO>
                <ns3:Parts>
                    ...
                    <ns3:Specification>
                   {
                     for $TagParam in  $sMSRequestPayload1/*:TagList/*:TagParam return 
if(data($TagParam/*:tagName)='PIN_FLD_PRIMARY_NUMBER') then
 <ns4:CharacteristicsValue characteristicName = "{data($TagParam/*:tagName)}">
                    ...
                    <ns4:CharacteristicsValue characteristicName = "{data($TagParam/*:tagName)}">
                            <ns4:Value>{data($TagParam/*:tagValue)}</ns4:Value>
                        </ns4:CharacteristicsValue>
                        }
                    </ns3:Specification>
                </ns3:Parts>
...
xf:XQ_SMSPayload_To_CreateCommunicationRequest_Req1($sMSRequestPayload1)