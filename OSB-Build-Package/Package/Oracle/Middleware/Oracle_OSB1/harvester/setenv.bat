...
@rem    The Harvester Home directory

set HARVESTER_HOME=%OSB_HOME%\harvester
...
set CLASSPATH=%CLASSPATH%;%HARVESTER_HOME%\client.harvester-11.1.1.7.0.jar
set CLASSPATH=%CLASSPATH%;%HARVESTER_HOME%\client.harvester-osb.jar
set CLASSPATH=%CLASSPATH%;%HARVESTER_HOME%\L10N
