...
optional = frozenset(['-ruleExpression','-displayName','-description','-entitlements', '-resourceActions', '-principals', '-codeSource', '-obligations'])
import jpsCmdHelp
...
connect()
import Opss
Opss.updatePolicy(appStripe=appStripe, policyName=policyName, displayName=displayName, description=description, ruleExpression=ruleExpression, entitlements=entitlements, resourceActions=resourceActions, principals=principals, codeSource=codeSource, obligations=obligations)
