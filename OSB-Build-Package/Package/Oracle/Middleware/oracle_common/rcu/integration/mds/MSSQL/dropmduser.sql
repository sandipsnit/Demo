...
--
--
-- DROPMDUSER.SQL - Drop MDS User
--
-- Note:
--   Drop login, user and schema that were created for MDS.
...
--
--   Examples: sqlcmd -S stada66 -U sa -P x -i dropmduser.sql -v SCHEMA_USER="john" DATABASE_NAME="mds"
-- 
-- MODIFIED    (MM/DD/YY)
-- erwang       12/27/06   - Globalization Support for SQL Server.
-- erwang       12/08/06   - Refact for rcu
-- erwang       12/13/06   - Skip Primary Key and Unique Index while removing
-- erwang       11/15/06   - Remove unused variables
-- erwang       11/13/06   - Created
--
go
set nocount on
