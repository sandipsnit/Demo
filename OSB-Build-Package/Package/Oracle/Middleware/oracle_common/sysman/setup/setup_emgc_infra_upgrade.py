#
# $Header: setup_emgc_infra_upgrade.py 18-apr-2008.05:40:00 ramalhot Exp $
#
# Copyright (c) 2004, 2008, Oracle. All rights reserved.  
#
#    NAME
#      setup_emgc_infra_upgrade.py
#
#    DESCRIPTION
...
def usage():
   ...
   System.out.println('############################################')
   System.out.println('usage: ')
   System.out.println('    asctl script setup_emgc_infra_upgrade.py <options>')
   System.out.println('options:')
   System.out.println('    --configfile  Configuration file')
   System.out.println('    --outfile     Output file from setup_emgc_infra_upgrade.py')
...
##############################################
## Functions to configure em upgrade infrastructure
##############################################

def init():
    #Reset exceptions
    lastException()
    logTime( "Starting EM MAS Infra upgrade Setup")
    f = cmdlog
    startRecording(file=f)

def over():
    logTime( "End of EM MAS Infra upgrade Setup")
    stopRecording()
...
def upgrade_ohs():
    logTime("Inside OHS Upgrade.")

def setup():
    connect_mas()
    # Setup oc4j & ohs for EM upgrade.
