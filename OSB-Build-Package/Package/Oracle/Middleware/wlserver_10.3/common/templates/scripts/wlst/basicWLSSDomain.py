...
addTemplate("C:/Oracle/Middleware/wlserver_10.3/common/templates/domains/sipserverdomain.jar")
...
writeDomain('C:/Oracle/Middleware/user_projects/domains/basicWLSSDomain')
closeTemplate()
