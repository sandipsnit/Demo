...
addTemplate("C:/Oracle/Middleware/wlserver_10.3/common/templates/domains/replicateddomain.jar")
...
writeDomain('C:/Oracle/Middleware/user_projects/domains/replicatedDomain')
closeTemplate()
