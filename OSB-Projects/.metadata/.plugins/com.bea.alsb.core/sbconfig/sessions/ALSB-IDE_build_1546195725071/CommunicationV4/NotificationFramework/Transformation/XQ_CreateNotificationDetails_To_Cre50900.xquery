...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:schema-type-parameter parameter="$tbDetails" type="ns0:TbDetails" location="../WSDL/CreateNotificationRecord.wsdl" ::)
...
xf:XQ_CreateNotificationDetails_To_CreateSMSRecord($tbDetails)]]></con:xquery>
    ...
    <con:dependency location="../Schema/CreateSMSRecord_table.xsd">
        <con:schema ref="CommunicationV4/NotificationFramework/Schema/CreateSMSRecord_table"/>
    </con:dependency>
</con:xqueryEntry>