...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$tbSmsDetailsCollection" element="ns0:TbSmsDetailsCollection" location="../Schema/GetSMSRecord_table.xsd" ::)
...
xf:XQ_GetSMSRecord_To_SendNotification($tbSmsDetailsCollection)]]></con:xquery>
