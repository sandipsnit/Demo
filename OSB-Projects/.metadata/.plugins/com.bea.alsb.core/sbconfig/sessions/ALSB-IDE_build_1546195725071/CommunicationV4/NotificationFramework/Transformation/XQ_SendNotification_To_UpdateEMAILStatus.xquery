...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$sendEmailNotificationResp" element="ns0:SendEmailNotificationResp" location="../Schema/Notification.xsd" ::)
...
xf:XQ_SendNotification_To_UpdateEMAILStatus($sendEmailNotificationResp,
    $tbEmailDetailsCollection)]]></con:xquery>
