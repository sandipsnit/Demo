...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-parameter parameter="$sMSRequestPayload1" element="ns2:SMSRequestPayload" location="../Schema/SendSMSIO.xsd" ::)
...
xf:XQ_SMSPayload_To_CreateCommunicationRequest_Req1($sMSRequestPayload1,$targetFormatDVM)]]></con:xquery>
    <con:dependency location="../Schema/SendSMSIO.xsd">
        <con:schema ref="CommunicationV4/Subscriber/CRM/Schema/SendSMSIO"/>
    </con:dependency>
