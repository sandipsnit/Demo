...
<con:xqueryEntry xmlns:con="http://www.bea.com/wli/sb/resources/config">
    <con:xquery><![CDATA[(:: pragma bea:global-element-return element="ns0:ErrorInformation" location="../Schema/ErrorInformation.xsd" ::)
...
xf:XQ_InternalFault($request)]]></con:xquery>
    <con:dependency location="../Schema/ErrorInformation.xsd">
        <con:schema ref="VFQA_CSM_Common/Schema/ErrorInformation"/>
    </con:dependency>
