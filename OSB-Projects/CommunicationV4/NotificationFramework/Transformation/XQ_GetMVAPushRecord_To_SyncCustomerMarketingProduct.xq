(:: pragma bea:global-element-parameter parameter="$tbMvaPushDetailsCollection" element="ns5:TbMvaPushDetailsCollection" location="../Schema/GetMVAPushRecord_table.xsd" ::)
...
xf:XQ_GetMVAPushRecord_To_SyncCustomerMarketingProduct($tbMvaPushDetailsCollection)