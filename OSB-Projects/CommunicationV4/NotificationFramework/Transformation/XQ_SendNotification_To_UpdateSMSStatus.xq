(:: pragma bea:global-element-parameter parameter="$sendSMSNotificationResp" element="ns1:SendSMSNotificationResp" location="../Schema/Notification.xsd" ::)
