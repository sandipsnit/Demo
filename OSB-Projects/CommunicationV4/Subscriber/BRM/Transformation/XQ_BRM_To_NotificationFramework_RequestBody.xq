(:: pragma  parameter="$VFQANotificationsRequest" type="anyType" ::)
...
xf:XQ_VFQANotificationsRequest_To_CreateCommunicationRequest_Req1($VFQANotificationsRequest,$targetFormatDVM)