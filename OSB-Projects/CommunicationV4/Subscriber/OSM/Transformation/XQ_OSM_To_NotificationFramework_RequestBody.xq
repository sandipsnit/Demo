(:: pragma bea:global-element-parameter parameter="$sendCommunicationListVBMRequest" element="ns0:SendCommunicationListVBMRequest" location="../../../../VFQA_CSM_Common/Schema/VBO/Communication/V1/CommunicationVBM.xsd" ::)
...
xf:XQ_SendCommunicationRequest_To_CreateCommunicationRequest_Req($sendCommunicationListVBMRequest,$targetFormatDVM,$accountNumber,$accType,$SubscriberNumber)